      ...
      <div className="max-w-4xl mx-auto" ref={reveal.elementRef}>
        <div className={`space-y-8 ${reveal.isRevealed ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          <div className="relative group">
            ...
            <div className={`absolute inset-0 bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 rounded-3xl blur-xl transition-all duration-500 ${isDragActive ? 'opacity-100 scale-105' : 'opacity-0 group-hover:opacity-50'}`}></div>
              ...
              {preview ? (
                <div className="relative w-full h-full min-h-[400px] p-4">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-8">
                    <p className="text-white font-mono">Click or drop to replace specimen</p>
                  </div>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                ...
                <div className="text-center p-12 space-y-6 relative z-10">
                  <div className={`w-24 h-24 rounded-full bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center mx-auto border border-white/10 transition-transform duration-500 ${isDragActive ? 'scale-125 rotate-180' : 'group-hover:scale-110'}`}>
          ...
          {file && !loading && (
            <div className="flex justify-center pt-4">
              <button
                ...
                className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-primary text-black font-bold text-lg transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(57,255,20,0.6)] overflow-hidden w-full md:w-auto justify-center"
              >
          ...
          {loading && (
            <div className="text-center space-y-4 pt-8">
              ...
              <h3 className="text-xl font-bold text-white animate-pulse">Processing Specimen...</h3>
