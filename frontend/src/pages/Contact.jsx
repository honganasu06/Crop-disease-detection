              ...
              >
                ...
                <div className="space-y-4">
                  {contactInfo.map((info, index) => (
                    ...
                    >
                                  <div className={`${info.color === 'primary' ? 'text-primary' : info.color === 'secondary' ? 'text-secondary' : 'text-accent'} p-3 rounded-lg glass-card flex items-center justify-center`}>{
